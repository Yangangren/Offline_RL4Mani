#!/usr/bin/env python3
"""Build or validate the MoveSpoon mixed one-step IDQL dataset."""
...
DEFAULT_ROLLOUT_DATASET = (
    ...
    "move_spoon_episode_layout_v1_one_step_rollouts.hdf5"
)
DEFAULT_OUTPUT = (
    ROOT
    / "datasets/real_robot/move_spoon/idql/"
    "move_spoon_idql_episode_layout_v1_45demo_20success_11failure_"
...
def configure_core() -> None:
    ...
    core.BUILDER_VERSION = "move_spoon_idql_mixed_v1_episode_layout_one_step"
    ...
    core.DEFAULT_HUMAN_DATASETS_HELP = (
        "MoveSpoon human HDF5 (defaults to the fixed 45-episode train split)."
    )
